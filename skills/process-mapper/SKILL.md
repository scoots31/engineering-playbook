...
This skill is not invoked by the solo. It is activated automatically by the phases it lives in.
...
| Process mapper being invoked by the solo | It should be invisible — always present, never prompted | It activates as part of discover, design sprint, design review, build, and phase test |
